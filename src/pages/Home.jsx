...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-yellow-50 pt-[76px]">
            ...
            <div className="lg:w-1/3 flex flex-col gap-3">
              {Object.keys(solutionsData).map((key) => (
                <button
                  ...
                  className={`flex items-center justify-between p-4 rounded-xl font-bold transition-all text-left ${activeTab === key
      ...
      <section className="relative py-20 px-4 bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-10%] right-[-5%] w-[35%] h-[50%] bg-orange-600/5 blur-[120px] rounded-full"></div>
          <div className="absolute bottom-[-10%] left-[-5%] w-[30%] h-[40%] bg-red-600/5 blur-[100px] rounded-full"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-14">
            <p className="text-orange-500 font-bold tracking-[0.3em] uppercase text-[10px] mb-3">
              Our Work
            </p>
            <h2 className="text-3xl md:text-4xl font-black text-white leading-tight mb-4">
              Recently <span className="text-orange-500">Delivered</span> Solutions
            </h2>
            <div className="flex justify-center items-center gap-1.5">
              <div className="w-8 h-[1px] bg-orange-600/50"></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {recentProjects.map((item, idx) => (
              <div
                ...
                className="group relative cursor-pointer opacity-0 animate-[fadeIn_0.6s_ease-out_forwards]"
              ...
              >
                ...
                <div className="relative h-full p-6 bg-[#111111] rounded-2xl flex flex-col items-center text-center transition-all duration-500 group-hover:bg-[#151515] group-hover:-translate-y-1 m-[1px]">
                  ...
                  {/* Icon */}
                  <div className="mb-5 p-4 bg-white/5 rounded-2xl group-hover:bg-orange-600 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6">
                    <div className="text-orange-500 group-hover:text-white transition-colors duration-500 group-hover:rotate-[-6deg]">
                      {item.icon}
                    </div>
                  </div>

                  {/* Title */}
                  <h3 className="text-sm font-bold text-gray-300 leading-snug group-hover:text-white transition-colors duration-300 mb-4">
                    {item.title}
                  </h3>

                  {/* Bottom accent line */}
                  <div className="mt-auto w-10 h-[2px] bg-gradient-to-r from-orange-500 to-red-500 rounded-full transition-all duration-500 group-hover:w-16"></div>
                </div>
              </div>
            ))}
          </div>
    ...
    `}} />
      ...
      <section className="relative py-16 px-6 bg-[#0a0a0a] overflow-hidden">
        {/* Background Glows */}
        ...
        <div className="absolute top-0 left-0 right-0 overflow-hidden leading-none pointer-events-none">
          <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full h-16 md:h-20">
            <path d="M0,40 C360,0 1080,80 1440,40 L1440,0 L0,0 Z" fill="#780606" />    </svg>
        </div>

        <div className="max-w-5xl mx-auto relative z-10 mt-6">
          {/* Heading */}
          <div className="text-center mb-10">
            <p className="text-orange-500 font-bold tracking-[0.3em] uppercase text-[9px] mb-2">
              Our Track Record
            </p>
            <h2 className="text-3xl md:text-4xl font-black text-white leading-tight mb-4">
              Delivering <span className="text-orange-500">Excellence</span> at Scale.
            </h2>
            <div className="flex justify-center items-center gap-1.5">
              <div className="w-8 h-[1px] bg-orange-600/50"></div>
              <div className="w-1.5 h-1.5 rounded-full bg-orange-600"></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
            {achievements.map((item, index) => (
              <div key={index} className="group relative">
                ...
                <div className="relative h-full p-6 bg-[#111111] rounded-2xl flex flex-col items-center justify-center transition-all duration-500 group-hover:bg-[#151515] group-hover:-translate-y-1 m-[1px]">
                  {/* Icon */}
                  <div className="mb-4">
                    <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 text-orange-500 group-hover:bg-orange-600 group-hover:text-white transition-all duration-500">
                  ...
                  <div className="text-center">
                    <div className="flex items-baseline justify-center gap-0.5">
                      <span className="text-2xl md:text-3xl font-black text-white group-hover:text-orange-500 transition-all duration-300">
                        <CounterAnimation end={item.value} />
                      </span>
                      <span className="text-sm font-bold text-orange-600">{item.suffix}</span>
                    </div>
                    <p className="mt-1 text-[9px] font-bold uppercase tracking-widest text-gray-500 group-hover:text-gray-300">
                      {item.label}
                    </p>
                  </div>
                </div>
