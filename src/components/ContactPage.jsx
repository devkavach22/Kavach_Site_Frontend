          ...
          return (
            ...
            >
              <circle
                ...
                r={isActive ? r + 12 : r + 7}
                fill={
                  isActive ? "rgba(184,57,52,0.20)" : "rgba(184,57,52,0.12)"
                }
...
function ContactPage() {
  ...
  // Handle input changes with integrated validations
  ...
  if (/^[a-zA-Z0-9@.+]*$/.test(value) && value.length <= 100) {
    setFormData((prev) => ({ ...prev, [name]: value }));
      ...
      if (value.length <= 250) {
        ...
        // Add this condition to limit subject to 100 characters
        if (value.length <= 100) {
          setFormData((prev) => ({ ...prev, [name]: value }));
        }
      }
  ...
  const offices = [
    {
      title: "Ahmedabad",
      address:
        "A/53, 5th floor, New York Tower, Thaltej, S G Highway, Ahmedabad - 380015.",
      mapUrl: "https://www.google.com/maps/search/?api=1&query=New+York+Tower+Thaltej+Ahmedabad",
    },
    {
      title: "Himachal Pradesh",
      address:
        "29, First Floor, Block1, Dev Bhoomi Apartments, Deonghat, Solan - 173211",
      mapUrl: "https://www.google.com/maps/search/?api=1&query=Dev+Bhoomi+Apartments+Deonghat+Solan",
    },
    {
      title: "Ayodhya",
      address:
        "4th Floor, Arundhati Bhawan West, Tedhi Bajar, Ayodhya, UP - 224123",
  ...
  return (
    <div
      style={{ backgroundColor: "#fff", overflowX: "hidden", width: "100%" }}
    >
      <style>{`
      ...
      >
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 50 }}>
            ...
            >
              Get In <span style={{ color: "#B83934" }}>Touch</span> With Our
              Experts
            </h2>
            <p
              style={{
              ...
              >
                {[
                  ...
                  <div
                    ...
                    style={{
                      borderBottom:
                        i === 3 ? "none" : "1px solid rgba(0,0,0,0.1)",
                      paddingBottom: 20,
                    }}
                  >
                    <p
      ...
      >
        <p style={{ color: "#B42A26", fontSize: 16, fontWeight: 500 }}>
          Global Network
        </p>
        <h2
          style={{
          ...
          {MARKERS.map((m) => (
            <div
              ...
              style={{
                ...
                cursor: "pointer",
                backgroundColor:
                  activeLocation === m.name ? "#B83934" : "#FFF1F0",
