            ...
            <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide scroll-smooth">
              {teamMembers.map((member, index) => (
                <div key={member.id} onClick={() => navigate(`/team/${member.id}`)}
                  className="group relative bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl flex-shrink-0 w-[280px] snap-center cursor-pointer opacity-0 animate-[fadeIn_0.6s_ease-out_forwards] transition-all duration-500 hover:-translate-y-2"
                  style={{ animationDelay: `${index * 100}ms` }}>
                  <div className="relative h-64 overflow-hidden bg-gradient-to-br from-orange-100 to-orange-50 rounded-t-xl">
                  ...
                  <div className="p-4 bg-white">
                    <h3 className="text-lg font-bold text-gray-900 mb-1 line-clamp-1 group-hover:text-orange-600 transition-colors duration-300">{member.name}</h3>
