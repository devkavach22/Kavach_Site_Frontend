...
//   const achievements = [
//     { icon: <Building2 className="w-6 h-6 text-orange-500" strokeWidth={2} />, value: 8, label: "Offices in India", suffix: "" },
//     { icon: <Users2 className="w-6 h-6 text-orange-500" strokeWidth={2} />, value: 23000, label: "Team", suffix: "+" },
//     { icon: <Phone className="w-6 h-6 text-orange-500" strokeWidth={2} />, value: 50, label: "Industries", suffix: "+" },
//     { icon: <Handshake className="w-6 h-6 text-orange-500" strokeWidth={2} />, value: 7500, label: "Clients", suffix: "+" },
//     { icon: <Globe2 className="w-6 h-6 text-orange-500" strokeWidth={2} />, value: 7, label: "Global Footprints", suffix: "+" },
//   ];

//   const values = [
//     { icon: <Shield className="w-8 h-8 text-orange-500" />, title: "Integrity", desc: "We operate with unwavering transparency and ethical conduct in every interaction and business decision." },
//     { icon: <Zap className="w-8 h-8 text-orange-500" />, title: "Innovation", desc: "We continuously push boundaries, leveraging cutting-edge technology to craft solutions for tomorrow's challenges." },
//     { icon: <Heart className="w-8 h-8 text-orange-500" />, title: "Client-Centric", desc: "Our clients are at the heart of everything we do. Their success is our mission and our greatest achievement." },
//     { icon: <Award className="w-8 h-8 text-orange-500" />, title: "Excellence", desc: "We hold ourselves to the highest standards, delivering quality that stands the test of time across every project." },
//   ];

//   const recentProjects = [
//     { id: "intelligent-traffic-management", title: "Intelligent Traffic Management System", icon: <Globe2 className="w-8 h-8" />, desc: "A smart city initiative that leverages AI and IoT for real-time traffic optimization." },
//     { id: "emergency-call-box", title: "Emergency Call Box", icon: <Phone className="w-8 h-8" />, desc: "Rapid-response emergency infrastructure deployed across critical public zones." },
//     { id: "gis-solution-mining", title: "GIS Solution For Mining", icon: <Building2 className="w-8 h-8" />, desc: "Geospatial intelligence platform transforming mineral extraction operations." },
//     { id: "payroll-solutions", title: "360 Degree Payroll Solutions", icon: <Users2 className="w-8 h-8" />, desc: "End-to-end HR and payroll automation serving thousands of employees nationwide." },
//   ];
...
//     { id: "jitendra-kumar", name: "Mr. Jitendra Kumar", position: "Director – Operations and Business Development", image: JitinImg },
//   ];
...
//             <span className="text-white text-xs font-semibold tracking-widest uppercase">About Kavach Global</span>
//             <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse"></span>
//           </div>
...
//           {/* ── ACHIEVEMENTS BANNER ── */}
//           <div className="mt-8 opacity-0 animate-[fadeIn_0.9s_ease-out_0.8s_forwards]">
//             <p className="text-xs uppercase tracking-widest text-white/70 font-semibold mb-4">Our Achievements at a Glance</p>
//             <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 max-w-3xl mx-auto">
//               {achievements.map((item, i) => (
//                 <div
//                   key={i}
//                   className="group relative bg-white/15 backdrop-blur-sm rounded-xl p-3 border border-white/20 shadow-sm hover:shadow-xl hover:-translate-y-2 hover:border-4 hover:border-orange-600 transition-all duration-300 text-center overflow-hidden cursor-default"
//                   style={{ animationDelay: `${i * 80}ms` }}
//                 >
//                   <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
//                   <div className="relative mb-2 inline-flex p-2 bg-white/20 rounded-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-400 shadow-sm">
//                     <div className="group-hover:rotate-[-6deg] transition-all duration-400">{item.icon}</div>
//                   </div>
//                   <div className="text-xl font-extrabold bg-gradient-to-r from-white to-white group-hover:from-yellow-200 group-hover:to-white bg-clip-text text-transparent transition-all duration-300">
//                     <CounterAnimation end={item.value} suffix={item.suffix} />
//                   </div>
//                   <p className="text-white/60 text-[10px] font-bold uppercase tracking-wider mt-0.5 group-hover:text-yellow-200 transition-colors duration-300">
//                     {item.label}
//                   </p>
//                   <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-orange-400 to-red-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-400 origin-center rounded-b-xl"></div>
//                 </div>
//               ))}
//             </div>
//           </div>
...
//           {/* Scroll indicator */}
//           <div className="mt-8 flex flex-col items-center gap-2 opacity-0 animate-[fadeIn_1s_ease-out_1.2s_forwards]">
...
//         <div className="max-w-7xl mx-auto">
//           <h2 className="text-3xl md:text-4xl font-bold text-center text-orange-600 mb-12">Our Mission & Vision</h2>
...
//                 To deliver integrated, technology-driven solutions that empower businesses to operate efficiently, securely, and sustainably. We are committed to transforming complex challenges into streamlined opportunities — enabling our clients to focus on what they do best while we manage the rest.
//               </p>
//             </div>
...
//               </div>
//               <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-orange-600 transition-colors duration-300">Our Vision</h3>
//               <p className="text-gray-600 leading-relaxed">
//                 To be the most trusted and innovative global conglomerate — recognized for transforming industries through cutting-edge technology, exceptional service delivery, and a deep commitment to societal progress. We envision a world where every organization has access to intelligent, scalable solutions.
//               </p>
//             </div>
//           </div>
//         </div>
...
//         <div className="max-w-7xl mx-auto">
//           <h2 className="text-3xl md:text-4xl font-bold text-center text-orange-600 mb-4">Our Core Values</h2>
//           <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">The principles that guide every decision, every solution, and every relationship we build.</p>
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
//             {values.map((val, idx) => (
//               <div key={idx} className="group relative bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-500 border border-orange-100 hover:border-orange-300 transform hover:-translate-y-2 text-center opacity-0 animate-[fadeIn_0.6s_ease-out_forwards] overflow-hidden" style={{ animationDelay: `${idx * 100}ms` }}>
...
//                 </div>
//                 <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-orange-600 transition-colors duration-300">{val.title}</h3>
...
//             <h2 className="text-3xl md:text-4xl font-bold text-orange-600 mb-4">Highlighting Our Recently Delivered Solutions</h2>
//             <p className="text-gray-600 max-w-2xl mx-auto">From smart cities to enterprise-grade systems — here's a glimpse of what we've built.</p>
//           </div>
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
...
//                     <div className="text-orange-600 transform group-hover:rotate-[-6deg] transition-all duration-500">{item.icon}</div>
//                   </div>
//                   <h3 className="text-lg font-bold text-gray-800 leading-snug group-hover:text-orange-600 transition-colors duration-300 mb-2">{item.title}</h3>
...
//                     <img src={member.image} alt={member.name} className="w-full h-full object-cover object-top origin-top group-hover:scale-110 transition-transform duration-700" />
...
//                     <div className="mb-2">
//                       <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-orange-600 transition-colors duration-300 line-clamp-1">{member.name}</h3>
...
//           .scrollbar-default::-webkit-scrollbar { height: 6px; }
//           .scrollbar-default::-webkit-scrollbar-track { background: #f1f1f1; border-radius: 10px; }
//           .scrollbar-default::-webkit-scrollbar-thumb { background: #fb923c; border-radius: 10px; }
//           .scrollbar-default::-webkit-scrollbar-thumb:hover { background: #f97316; }
//         `}} />
//       </section>
...
//             <span className="bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent">Kavach Global?</span>
//           </h2>
...
//             <button onClick={() => navigate("/contact")} className="inline-block px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-orange-500/30 hover:scale-105 transition-all duration-300">Get In Touch</button>
//             <button onClick={() => navigate("/")} className="inline-block px-8 py-4 bg-white/10 text-white border border-white/20 rounded-xl font-semibold hover:bg-white/20 hover:scale-105 transition-all duration-300 backdrop-blur-sm">Explore Solutions</button>
//           </div>
//         </div>
//       </section>
...
const About = () => {
  ...
  const achievements = [
    { icon: <Building2 className="w-7 h-7" strokeWidth={2} />, value: 8, label: "Offices in India", suffix: "", color: "from-orange-500 to-orange-600", bg: "bg-orange-50", text: "text-orange-600" },
    { icon: <Users2 className="w-7 h-7" strokeWidth={2} />, value: 23000, label: "Team Members", suffix: "+", color: "from-red-500 to-red-600", bg: "bg-red-50", text: "text-red-600" },
    { icon: <Phone className="w-7 h-7" strokeWidth={2} />, value: 50, label: "Industries Served", suffix: "+", color: "from-amber-500 to-orange-500", bg: "bg-amber-50", text: "text-amber-600" },
    { icon: <Handshake className="w-7 h-7" strokeWidth={2} />, value: 7500, label: "Happy Clients", suffix: "+", color: "from-orange-600 to-red-600", bg: "bg-orange-50", text: "text-orange-600" },
    { icon: <Globe2 className="w-7 h-7" strokeWidth={2} />, value: 7, label: "Global Footprints", suffix: "+", color: "from-red-600 to-orange-700", bg: "bg-red-50", text: "text-red-600" },
  ];
    ...
    <div className="min-h-screen bg-white pt-[76px]">
      ...
      <section className="relative py-12 pb-20 px-4 overflow-hidden bg-gradient-to-br from-orange-600 via-red-600 to-orange-300">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {/* Scroll indicator */}
          <div className="mt-8 flex flex-col items-center gap-2 opacity-0 animate-[fadeIn_1s_ease-out_0.9s_forwards]">
            <span className="text-xs text-white/60 uppercase tracking-widest font-medium">Scroll to explore</span>
            <div className="w-5 h-8 border-2 border-white/50 rounded-full flex items-start justify-center p-1">
              <div className="w-1 h-2 bg-white rounded-full animate-[scrollBounce_1.5s_ease-in-out_infinite]"></div>
            </div>
      ...
      {/* ── ACHIEVEMENTS SECTION (SEPARATE) ── */}
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <p className="text-xs uppercase tracking-widest text-orange-500 font-bold mb-2">By the Numbers</p>
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">Our Achievements at a Glance</h2>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5">
            {achievements.map((item, i) => (
              <div
                key={i}
                className="group relative bg-white rounded-2xl p-6 border border-gray-100 shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 text-center overflow-hidden cursor-default"
                style={{ animationDelay: `${i * 80}ms` }}
              >
                {/* Top gradient bar */}
                <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${item.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}></div>

                {/* Soft bg glow */}
                <div className={`absolute inset-0 ${item.bg} opacity-0 group-hover:opacity-40 transition-opacity duration-300 rounded-2xl`}></div>

                {/* Icon */}
                <div className={`relative mx-auto mb-4 w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-400`}>
                  <div className="group-hover:rotate-[-6deg] transition-all duration-400">{item.icon}</div>
                </div>

                {/* Counter */}
                <div className={`relative text-3xl font-extrabold ${item.text} mb-1`}>
                  <CounterAnimation end={item.value} suffix={item.suffix} />
                </div>

                <p className="relative text-gray-500 text-xs font-semibold uppercase tracking-wider">
                  {item.label}
                </p>

                {/* Bottom accent */}
                <div className={`absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r ${item.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-center`}></div>
              </div>
            ))}
          </div>
        </div>
